...
| `date_range_from` | `string` | | The start of the `custom` date-range to display, in `YYYY-MM-DD` format |
| `date_range_to` | `string` | | The end of the `custom` date-range to display, in `YYYY-MM-DD` format |
